...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--prob_no_normalize", "-prob_no_normalize", help="No Normalize: Confidence score", action="store_true"
    )
    ...
    if args.d == "mnist":
        ...
        if args.adv_good and args.prob_no_normalize:
            dsa_test_score = './sa/prob_no_normalize_mnist.txt'
            dsa_adv_score = './sa/prob_adv_no_normalize_mnist.txt'
            ...
            data = [dsa_test_score, dsa_adv_score]
            fig, ax = plt.subplots()
            ax.set_title('Incorrect-Confidence Score (NN): Test vs Adversarial Examples of {} dataset'.format(args.d))
            ax.boxplot(data)
            ax.set_xticklabels(['Test', 'Adv'])
            plt.savefig('./figures/prob_no_normalize_incorrect_test_vs_adversarial_{}.jpg'.format(args.d))
    ...
    if args.d == "cifar":
        ...
        if args.adv_good and args.prob_no_normalize:
            dsa_test_score = './sa/prob_no_normalize_cifar.txt'
            dsa_adv_score = './sa/prob_adv_no_normalize_cifar.txt'
